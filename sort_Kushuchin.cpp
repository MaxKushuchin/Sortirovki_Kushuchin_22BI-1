...
//Эта функция выполняет часть операций в алгоритме быстрой сортировки. Она находит правильное место для опорного элемента и разделяет массив на две части.
...
//Эта функция реализует алгоритм быстрой сортировки. Она рекурсивно вызывает pilot_replace
...
//Эта функция реализует сортировку выбором, находя наименьший элемент и помещая его в начало массива (рекурсивно вызывает FindSmallestPos).
...
//Эта функция реализует сортировку пузырьком, последовательно сравнивая и меняя местами соседние элементы.
